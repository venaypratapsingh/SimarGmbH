...
<div class="topbar-left">
    <a href="/" class="logo">
        <span>
                <h1 style="color: white; ">SIMAR GMBH</h1>
            </span>
        <i>
            <h1>S</h1>
            </i>
    ...
    <ul class="navbar-right d-flex list-inline float-right mb-0">
        ...
        <li class="dropdown notification-list d-none d-md-block">
            ...
            <div class="dropdown-menu dropdown-menu-right language-switch">
                ...
                <a class="dropdown-item" href="{{ route('lang', 'de') }}"><img src="assets/images/flags/germany_flag.jpg" alt="" height="16" /><span> German </span></a>
            </div>
        </li>
        ...
        <li class="dropdown notification-list">
            <div class="dropdown notification-list nav-pro-img">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <!-- item-->
                    <a class="dropdown-item" href="#"><i class="mdi mdi-account-circle m-r-5"></i> {{ __('global.profile') }}</a>

                    {{-- <a class="dropdown-item d-block" href="#"><span class="badge badge-success float-right">11</span><i class="mdi mdi-settings m-r-5"></i> Settings</a> --}}
                    <a class="dropdown-item" href="#"><i class="mdi mdi-lock-open-outline m-r-5"></i> {{ __('global.lock_screen') }}</a>
