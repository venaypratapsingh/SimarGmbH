...
<div class="modal fade" id="edit{{ $employee->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title"><b><span class="employee_id">{{ __('global.update_employee') }}</span></b></h4>
            <div class="modal-body text-left">
                <form class="form-horizontal" method="POST" action="{{ route('employees.update', $employee->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="restaurant" name="restaurant" value="{{ $employee->restaurant }}"
                            required>

                    </div>

                    <div class="form-group">
                        <label for="member_since" class="col-sm-3 control-label">Member Since</label>
                        <input type="date" class="form-control" id="member_since" name="member_since" value="{{ $employee->member_since }}" required>
                    </div>

                    <!-- Removed Email Edit Input -->
                    <!--
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header " style="align-items: center">
              ...
              <h4 class="modal-title "><span class="employee_id">{{ __('global.delete_employee') }}</span></h4>
